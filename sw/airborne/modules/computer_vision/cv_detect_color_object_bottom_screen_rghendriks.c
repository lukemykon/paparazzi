...
// Own header
#include "modules/computer_vision/cv_detect_color_object_bottom_screen_rghendriks.h"
...
uint16_t cod_y_min1 = 0; 
uint16_t cod_y_min2 = 0;
...
static struct image_t *object_detector(struct image_t *img, uint8_t filter)
{
  ...
  uint32_t count = find_object_centroid(img, &x_c, &y_c, draw, lum_min, lum_max, cb_min, cb_max, cr_min, cr_max, y_min);
...
void color_object_detector_init(void)
{
  ...
  cod_y_min1 = COLOR_OBJECT_DETECTOR_Y_MIN1;
#endif
